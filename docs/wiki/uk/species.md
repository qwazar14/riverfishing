...
Кої — це вид (1.0.0): `koi_carp`, одна риба з трьома локусами забарвлення й локусом корони; породу читають із генотипу й пишуть на картку. У дикій воді вона живе лише у **вишневому гаю** і клює там як будь-який короп, а живе всюди, куди її випустив власник: приватний став із виведеними кої ловиться як став із коропом. П'ять старих id (Кохаку, Танчо Санке, Сьова Санке, Асагі та Бекко як окремі види) і старе правило — короп на короповій снасті з шансом обертається на кої — прибрано; стара скриня з такими предметами їх втрачає.

Кої **не йдуть у залік за кількістю видів**: ні в східчастих досягненнях на «N видів», ні в *Повному бестіарії* — у них своє, *Жива коштовність*. Пустити кої на філе можна: твоє ім'я піде в чат сервера з підписом *«ти серйозно пустив її на філе?»*, а слідом прийде досягнення *Безсердечний кухар*.
