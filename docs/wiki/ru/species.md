...
Кои — это вид (1.0.0): `koi_carp`, одна рыба с тремя локусами окраса и локусом короны; породу читают с генотипа и пишут на карточку. В дикой воде она живёт только в **вишнёвой роще** и клюёт там как любой карп, а живёт везде, куда её выпустил владелец: частный пруд с выведенными кои ловится как пруд с карпом. Пять старых id (Кохаку, Танчо Санке, Сёва Санке, Асаги и Бекко как отдельные виды) и старое правило — карп на карповой снасти с шансом оборачивается кои — убраны; старый сундук с такими предметами их теряет.

Кои **не идут в зачёт по числу видов**: ни в ступенчатых достижениях на «N видов», ни в *Полном бестиарии* — у них своё, *Живая драгоценность*. Пустить кои на филе можно: ваше имя уйдёт в чат сервера с подписью *«ты серьёзно её на филе пустил?»*, а следом придёт достижение *Бессердечный повар*.
