...
For every one of the 91 species, the engine computes an attractiveness weight **W**. Species with W above zero go into a weighted lottery for *which* fish bites; the **sum** of all their weights decides *how long you wait*.
