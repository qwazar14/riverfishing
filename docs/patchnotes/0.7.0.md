...
Asked for plainly by **arsen_501**. This mod ships twenty-three lines, nine hook sizes, eleven rig
...
gates, fight profile, journal page and trades. The tarpon is the heaviest of the nine: angler level 9, 130 kg,
...
- **On 26.1.2 and 26.2 specifically**, a runtime pass found faults a green compile cannot catch. The
  ...
  The Tackle Station also never showed a result. Both fixed.
...
- **Legendary fish are the size they claim** on 26.x, where the icon scale ladder stopped short of them
  and every legendary came out the same size as an ordinary big fish.
