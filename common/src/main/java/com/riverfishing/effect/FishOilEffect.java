 ...
 * only fires the "effect started" hook on the FIRST application. Clearing while the oil is in you is also
 * what the patchnote promises. The cost is one absent-key map lookup per tick after the first.
 *
