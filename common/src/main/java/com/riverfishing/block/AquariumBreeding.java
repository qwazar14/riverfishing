...
public final class AquariumBreeding {
    ...
    private static int variety(ItemStack fish) {
        String v = CatchCard.of(fish).getString("Variety");
        if (v.isEmpty()) {
     ...
     */
    private static double rate(ResourceLocation a, ResourceLocation b) {
    ...
    private static ResourceLocation hybridOr(ResourceLocation mother, ResourceLocation father) {
