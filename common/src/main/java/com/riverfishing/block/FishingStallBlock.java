...
public class FishingStallBlock extends Block implements net.minecraft.world.level.block.EntityBlock {
    ...
    /**
     * §1.20.1: there is no {@code useWithoutItem} — {@code use} fires whatever the player is holding, so
     * the empty-hand rule the 1.21 build gets for free is enforced here. Without it, right-clicking the
     * stall while holding a fish or a rod would pop the bench instead of doing the obvious thing.
     */
    @Override
