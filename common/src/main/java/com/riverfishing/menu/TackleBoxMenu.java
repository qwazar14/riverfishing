...
public class TackleBoxMenu extends AbstractContainerMenu {
    ...
    public boolean stillValid(Player p) {
        ...
        return !source.isBlock() || p.distanceToSqr(net.minecraft.world.phys.Vec3.atCenterOf(source.pos())) <= 64.0;
    }
    ...
    private static void openAt(ServerPlayer sp, Source source) {
        MenuRegistry.openExtendedMenu(sp, new MenuProvider() {
            ...
            public Component getDisplayName() {
                return ItemStack.EMPTY.getDisplayName(); // the screen draws the box's own name field
            }
