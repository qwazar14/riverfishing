...
public final class FightKeys {
    ...
    // 26.x turned the category from a lang key into a KeyMapping.Category record over an Identifier.
    // 26.1.2 and 26.2 agree, so this is a per-branch line rather than a stonecutter conditional.
