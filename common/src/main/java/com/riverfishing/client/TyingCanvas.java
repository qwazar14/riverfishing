...
public final class TyingCanvas {
    ...
    public void draw(GuiGraphicsExtractor g, Font font, int left, int top, int mouseX, int mouseY, boolean canTie) {
    ...
    private static void paletteCell(GuiGraphicsExtractor g, int x0, int y0, int px, int[] cost, Inventory inv) {
