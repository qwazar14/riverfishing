...
public class FinderScreen extends Screen {
    ...
    private void renderMap(GuiGraphicsExtractor g, int mouseX, int mouseY) {
        ...
        g.text(this.font, Component.translatable("finder.riverfishing.metres", 10), sx + 2, sy - 12, 0x9940E0B0, false);
    ...
    private List<Line> sampleLines() {
        ...
        if (data.contains("owner")) {
            out.add(pairLine("finder.riverfishing.owner", Component.literal(data.getStringOr("owner", ""))));
        }
        return out;
    }
