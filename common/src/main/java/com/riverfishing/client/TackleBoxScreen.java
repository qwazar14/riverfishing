...
public class TackleBoxScreen extends AbstractContainerScreen<TackleBoxMenu> {
    ...
    public TackleBoxScreen(TackleBoxMenu menu, Inventory inv, Component title) {
        ...
        this.imageWidth = TackleBoxMenu.PANEL_WIDTH;
        this.imageHeight = TackleBoxMenu.panelHeight(menu.tier());
    ...
    protected void init() {
        ...
        String current = box.hasCustomHoverName() ? box.getHoverName().getString() : "";
        sent = current;
    ...
    public void render(GuiGraphics g, int mouseX, int mouseY, float partialTick) {
        ...
        g.renderItem(menu.box(), leftPos + imageWidth - 24, topPos + TackleBoxMenu.NAME_TOP - 7);
