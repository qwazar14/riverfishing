...
public class CullScreen extends Screen {
    ...
    private void renderCategories(GuiGraphics g, int mouseX, int mouseY) {
        ...
        for (int c = 0; c < cats.size(); c++) {
            ...
            g.drawString(font, label, x + 5, y + 3, c == cat ? 0xFFFFFFFF : 0xFFC0C0C0, false);
            g.drawString(font, Component.literal(count).withStyle(ChatFormatting.DARK_GRAY),
    ...
    private void renderList(GuiGraphics g, int mouseX, int mouseY) {
        ...
        if (shown == 0) {
            g.drawString(font, Component.translatable("gui.riverfishing.cull_none_here")
        ...
        for (int i = 0; i < shown; i++) {
            ...
            Component line = st == CullListPacket.CULLED
                    ...
                    : name(idx).copy();
            g.drawString(font, line, x + 9, y + 3, TEXT[st], false);
            if (sel) {
                ...
                g.drawString(font, no.copy().withStyle(ChatFormatting.DARK_RED),
