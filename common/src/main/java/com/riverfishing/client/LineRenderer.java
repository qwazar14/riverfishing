...
public final class LineRenderer {
    ...
    private static void line(VertexConsumer vc, Matrix4f m, Matrix3f nrm, Vec3 a, Vec3 b,
        ...
        vc.vertex(m, (float) a.x, (float) a.y, (float) a.z).color(r, g, bl, alpha).normal(nrm, dx, dy, dz).endVertex();
        vc.vertex(m, (float) b.x, (float) b.y, (float) b.z).color(r, g, bl, alpha).normal(nrm, dx, dy, dz).endVertex();
    }
}
