...
public class TackleStationScreen extends AbstractContainerScreen<TackleStationMenu> {
    ...
    public void extractBackground(GuiGraphicsExtractor g, int mouseX, int mouseY, float partialTick) {
        ...
        g.text(font, new ItemStack(sel.item()).getHoverName(), rx, y + GRID_Y, 0xFFEDE4D0, false);
        ...
        g.text(font, I18n.get("screen.riverfishing.tackle_station.cast_hint",
                TackleForm.castHintBlocks(grams)), rx, y + GRID_Y + 30, 0xFFB8AE9A, false);
        g.text(font, I18n.get("screen.riverfishing.tackle_station.cost",
                sel.ironFor(grams), sel.stringNeeded()), rx, y + GRID_Y + 44, 0xFFB8AE9A, false);
        if (sel.dyeable) {
            g.text(font, I18n.get("screen.riverfishing.tackle_station.dye_hint"),
        ...
        *///?}
        ...
        for (int i = 0; i < ghosts.length; i++) {
            ...
            if (need[i] > 0) {
                ...
                g.centeredText(font, "×" + need[i], x + wells[i][0] + 8, y + 157,
                        short_ ? 0xFFE06050 : 0xFF9a8d78);
            }
        }
        g.text(font, "→", x + 134, y + 142, 0xFFB8AE9A, false);
