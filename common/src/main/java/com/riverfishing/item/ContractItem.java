...
public class ContractItem extends Item {
    ...
    public static net.minecraft.network.chat.MutableComponent headline(CompoundTag t) {
        if (isFry(t)) return Component.translatable("journal.riverfishing.contract_fry_row", t.getIntOr("N", 0),   // §e
                Component.translatable("fish.riverfishing." + t.getStringOr("Sp", "")));
    ...
    public static boolean isFry(CompoundTag t) {
        return "fry".equals(t.getStringOr("Kind", ""));
    }
