...
public class FishMealItem extends BoneMealItem {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, net.minecraft.world.item.component.TooltipDisplay display, java.util.function.Consumer<Component> tooltip, TooltipFlag flag) {
        tooltip.accept(Component.translatable("tooltip.riverfishing.fish_meal").withStyle(s -> s.withColor(0x7F8C99)));
        tooltip.accept(Component.translatable("tooltip.riverfishing.fish_meal_fry").withStyle(s -> s.withColor(0x7F8C99)));
    }
}
