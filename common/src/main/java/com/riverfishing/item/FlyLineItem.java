...
public class FlyLineItem extends LineItem {
    ...
    public void appendHoverText(ItemStack stack, net.minecraft.world.level.Level level, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("tooltip.riverfishing.fly_line_geometry_" + geometry.key).withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable("tooltip.riverfishing.fly_line_buoyancy_" + buoyancy.key).withStyle(ChatFormatting.DARK_AQUA));
